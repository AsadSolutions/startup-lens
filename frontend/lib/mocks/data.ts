...
const compostReport: FinalReport = {
  run_id: "example-smart-compost",
  idea: {
    idea: "A hardware subscription for smart compost bins with municipal partnerships",
    industry: "Climate Hardware",
    geography: "European Union",
  },
  executive_summary:
    "Municipal composting mandates create a real demand trigger, but hardware capex and multi-year municipal sales cycles make this slow and capital-intensive relative to the size of the near-term addressable market.",
  readiness_verdict: "weak",
  readiness_note: "Real regulatory tailwind, but hardware capex and municipal sales cycles work against a fast, capital-efficient launch.",
  team_reports: [
    {
      team: "market_research",
      summary: "EU composting mandates are expanding, but household adoption of connected bins remains early.",
      key_insights: [
        "Several EU member states have expanded mandatory organic waste separation since 2024",
        "Connected/smart bin adoption is still a small fraction of the broader composting hardware market",
      ],
      risks: ["Mandate enforcement varies significantly by municipality, weakening the demand signal."],
      sources: [
        { title: "European Commission: Waste Framework Directive updates", url: "https://environment.ec.europa.eu/", published: "2025-03-15" },
      ],
      truncated: false,
      spend: 7000,
    },
    {
      team: "competitor_analysis",
      summary: "A handful of smart bin makers exist but few pursue municipal partnerships directly.",
      key_insights: [
        "Existing smart compost hardware targets direct-to-consumer sales, not municipal contracts",
        "Municipal waste contracts are typically won by large incumbent waste-management firms",
      ],
      risks: ["Incumbent waste-management vendors have existing municipal relationships that are hard to displace."],
      sources: [{ title: "Waste Dive: Smart Bin Vendor Landscape", url: "https://www.wastedive.com/", published: "2025-05-27" }],
      truncated: false,
      spend: 5800,
    },
    {
      team: "investment_landscape",
      summary: "Climate hardware funding has cooled, and investors show a preference for asset-light models in this cycle.",
      key_insights: [
        "Hardware-heavy climate startups have seen slower fundraising than software-first climate tools since 2024",
        "The few funded comparables lean on grant or municipal-contract revenue rather than venture-scale growth",
      ],
      risks: ["Small sample of comparable deals makes this read directionally, not statistically."],
      sources: [{ title: "Crunchbase: Climate Hardware Funding Trends", url: "https://news.crunchbase.com/", published: "2025-09-11" }],
      truncated: false,
      spend: 6300,
    },
    {
      team: "moat_scoring",
      summary: "Municipal contracts, once won, are sticky, but winning the first one is slow and does not compound quickly.",
      key_insights: [
        "Municipal procurement relationships are durable once established",
        "Hardware manufacturing does not offer a meaningful technology edge over incumbents",
      ],
      risks: ["The moat only forms after a slow first sale; nothing protects the pre-contract period."],
      sources: [{ title: "OECD: Municipal Procurement Cycles", url: "https://www.oecd.org/", published: "2025-02-08" }],
      truncated: false,
      spend: 6700,
    },
    {
      team: "gtm_strategy",
      summary: "A pilot-city strategy in early-mandate countries is the only realistic entry path.",
      key_insights: [
        "Beachhead: mid-size municipalities in early-mandate countries (e.g. Netherlands, Belgium) with active composting budgets",
        "Pilot programs with a single city are the standard entry mechanism in this category",
      ],
      risks: ["Pilot-to-contract conversion timelines commonly run 12-24 months."],
      sources: [{ title: "Circular Economy municipal pilot case studies", url: "https://circulareconomy.europa.eu/", published: "2025-06-19" }],
      truncated: false,
      spend: 6200,
    },
  ],
  team_failures: [],
  moat_breakdown: [
    { dimension: "network_effects", score: 0, justification: "No meaningful network effect between bins, households, or municipalities." },
    { dimension: "switching_costs", score: 3, justification: "Municipal contracts are sticky once signed, with real replacement friction." },
    { dimension: "technology_edge", score: 1, justification: "Sensor and connectivity hardware is largely commodity." },
    { dimension: "brand", score: 1, justification: "No established brand advantage in municipal waste procurement." },
    { dimension: "regulation", score: 4, justification: "Composting mandates are a direct regulatory tailwind for demand, though not a moat against competitors." },
  ],
  contradictions: [
    {
      teams: ["market_research", "gtm_strategy"],
      description:
        "Market Research frames expanding composting mandates as a growing tailwind, while GTM Strategy notes pilot-to-contract conversion regularly takes 12-24 months. The regulatory trend may be real without translating into a fast go-to-market.",
    },
  ],
